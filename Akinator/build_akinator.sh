...
echo "Building..."
g++ main.cpp tree.cpp safetyTree.cpp graphDebug.cpp akinator.cpp filesFuncs.cpp \
 -o akinator.out -D _DEBUG -g -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ -Wc++14-compat -Wmissing-declarations -Wcast-align -Wcast-qual \
